...
mod tests {
    ...
    fn test_get_rainbow_dress_red() {
        let red = Color::srgba(234.0 / 255.0,59.0 / 255.0, 54.0 / 255.0, 1.0);
        assert_eq!(red, get_rainbow_dress_red());
    }
    #[test]
    fn test_get_rainbow_dress_orange() {
        let orange = Color::srgba(241.0 / 255.0,119.0 / 255.0, 46.0 / 255.0, 1.0);
        assert_eq!(orange, get_rainbow_dress_orange());
    }
    #[test]
    fn test_get_rainbow_dress_yellow() {
        let yellow = Color::srgba(248.0 / 255.0,230.0 / 255.0, 32.0 / 255.0, 1.0);
        assert_eq!(yellow, get_rainbow_dress_yellow());
    }

    #[test]
    fn test_get_rainbow_dress_blue() {
        let blue = Color::srgba(32.0 / 255.0,186.0 / 255.0, 222.0 / 255.0, 1.0);
